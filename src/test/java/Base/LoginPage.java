...
public class LoginPage extends BasePage{
    ...
    public void loginToWebsite() throws InterruptedException {
        ...
        //WebElement hoverLogInButton = driver.findElement(By.xpath("//div[@class='gekhq4-5 grTfZj'][1]"));
        WebElement hoverLogInButton = driver.findElement(By.cssSelector("div.gekhq4-4.egoSnI"));
